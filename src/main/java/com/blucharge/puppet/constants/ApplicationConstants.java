...
public class ApplicationConstants {
    ...
    public static final Integer METER_START_VALUE = random.nextInt(25) + 1;
    public static final Integer METER_STOP_VALUE = 98;
    public static final Integer RESERVATION_ID = 11;
    public static final Integer TRANSACTION_ID = 1;
    public static final Integer CONNECTOR_ID = random.nextInt(3) + 1;
